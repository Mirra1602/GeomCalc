...
### add a button:
        Btn = wx.Button(self.panel, wx.ID_ANY, 'Push me')
...
### do the layout
        ...
        # self.FigureBox = wx.BoxSizer(wx.HORIZONTAL)
...
### also sets the Formula output       
        if self.ch1.Selection == 7 :
            option2 = { 1 : get_shape.area,
                        2 : get_shape.circumferance}
            if self.ch2.Selection == 1:
                self.outFormula.Value = get_shape.area_formula
            else: 
                self.outFormula.Value = get_shape.circumferance_formula
        else:
            option2 = { 1 : get_shape.area,
                        2 : get_shape.perimeter}
            if self.ch2.Selection == 1:
                self.outFormula.Value = get_shape.area_formula
            else: 
                self.outFormula.Value = get_shape.perimeter_formula
